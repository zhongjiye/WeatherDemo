 ...
 * @author Maxwin
 * @description An ListView support (a) Pull down to refresh, (b) Pull up to load more. Implement
 * IXListViewListener, and see stopRefresh() / stopLoadMore().
 */
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (getFirstVisiblePosition() == 0
                    ...
                    ;
                    mHeaderView.setScrollHeader(deltaY/2.0f);
